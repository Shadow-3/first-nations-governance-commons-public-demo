...
- `docs/public-demo-release-notes-v2.9.md`
...
- `docs/private-pilot-launch-playbook-v2.9.md`
- `docs/toastmasters-private-pilot-launch-plan-v2.9.md`
- `docs/private-pilot-learning-and-decision-brief-v2.9.md`
...
## v2.7 Pilot Operations Control Upgrade

The v2.7 package adds a run-day operations layer after Private Pilot Readiness:

- Interactive Pilot Operations Control page.
- Sixteen run-day operations checks.
- Twelve participant state rules.
- Ten incident and closeout rehearsal rows.
- Eight official handoff rules.
- Browser-generated pilot operations brief.
- Private pilot operations runbook and Toastmasters operations script.
- Document viewer coverage for all v2.7 pilot operations docs, CSVs, and JSON.
- Package manifest coverage for the new pilot operations evidence group.
...
## v2.9 Private Pilot Launch Control Upgrade

The v2.9 package adds the controlled launch layer needed after private pilot implementation approval:

- Interactive Private Pilot Launch Control page.
- Eighteen launch gates.
- Fourteen intake states.
- Twelve communication artifacts.
- Ten learning metrics.
- Browser-generated launch brief.
- Private pilot launch playbook, Toastmasters launch plan, and learning/decision brief.
- Document viewer coverage for all v2.9 launch docs, CSVs, and JSON.
- Package manifest coverage for the new private pilot launch evidence group.
...
The v5.3 package adds the missing post-run decision layer:

- Eleven P0 outcome records, sixteen evidence acceptance records, eighteen issue records, twenty-eight controlled sample results, ten provider-boundary results, twelve owner signoffs, eight final decisions, ten public summary lines, sixteen next actions, and one hundred and twenty-nine total decision records.
- A stricter final gate: limited private pilot, provider real-record access, outbound email, official Toastmasters workflows, and live Decidim access remain blocked until every P0 outcome passes, every P0 evidence item is accepted, every P0 issue is closed, and every required owner signs off privately.
- Public-safe outcome wording only: private evidence, real participant records, official Toastmasters records, provider records, credentials, logs, and private minutes remain outside the package.

Use this version as the default public demo and private operating pack after the controlled fake/sample stress run.
