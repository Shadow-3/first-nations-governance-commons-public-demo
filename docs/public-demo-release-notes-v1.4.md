# Public Demo Release Notes v1.4
...
- Added v1.4 files to the manifest and document viewer catalog.

## What Did Not Change

- The demo remains dependency-free static HTML/CSS/JS.
- All data remains fake/sample data.
- The repository contribution model does not approve real community authority, real data use, or real pilot launch.
