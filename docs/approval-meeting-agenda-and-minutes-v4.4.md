# Approval Meeting Agenda and Minutes Pack v4.4

Use this pack to run a private meeting without exposing minutes or evidence in the public repository.
...
## Conflict and recusal register

| id | role | track | status | risk | recusalRule | publicBoundary |
| --- | --- | --- | --- | --- | --- | --- |
| CON-001 | Dean trusted reviewer | Cross-track | Ready | Advisory role mistaken for approval. | May advise; must not vote owner approvals. | Advisory only. |
| CON-002 | Barayamal program operator | Barayamal | Hold | Program interest in Barayamal-only pathway. | Can present facts; authority/privacy owners decide their gates. | No personal/business details. |
| CON-003 | Official-route owner | FN Toastmasters | Blocked | Official records may be confused with Decidim sample data. | Can approve boundary; no Decidim member-record storage. | No member records. |
| CON-004 | Privacy reviewer | Cross-track | Blocked | Privacy owner may need separate evidence access. | Access only required private evidence. | No evidence public. |
| CON-005 | Support owner | Cross-track | Blocked | Support records too sensitive for meeting room. | Summarise route; keep details outside docket. | No support details. |
| CON-006 | Technical custodian | Cross-track | Hold | Admin may see more than needed. | Prove least privilege and revoke. | No logs/credentials. |
| CON-007 | Provider access owner | Cross-track | Hold | Provider may gain excess access. | Provider access requires contract controls. | No provider evidence public. |
| CON-008 | Comms lead | Cross-track | Ready | Public language could overstate readiness. | Use approved redaction checklist. | Public-safe line only. |
| CON-009 | Training owner | Cross-track | Hold | Meeting script could imply official decisions. | Use fake-data-only training script. | Aggregate only. |
| CON-010 | Authority chair | Cross-track | Blocked | Authority route not yet proven. | Do not approve launch before route confirmed. | Status only. |
| CON-011 | Cultural safety reviewer | Cross-track | Blocked | Cultural material could be mishandled. | Stop and route privately if triggered. | No cultural material. |
| CON-012 | Closeout archivist | Cross-track | Hold | Archive could include private evidence. | Archive index only; evidence stays private. | Public status only. |
...
| id | auditEvent | status | owner | evidence | finding | nextAction |
| --- | --- | --- | --- | --- | --- | --- |
| AUD-001 | v4.3 gates imported | Ready | Pilot owner | Gate package v4.3 | Gate room exists. | Use v4.4 docket. |
| AUD-002 | Meeting scope set to fake-data only | Ready | Meeting chair | AGD-001 | Scope safe. | Read at meeting open. |
| AUD-003 | Authority evidence unavailable | Blocked | Authority chair | EVD-001 | Blocks real intake. | Book authority review. |
| AUD-004 | Privacy field schedule unavailable | Blocked | Privacy reviewer | EVD-002 | Blocks data collection. | Review field schedule. |
| AUD-005 | IDS/data conditions unavailable | Blocked | IDS/data reviewer | EVD-003 | Blocks data processing. | Review controls. |
| AUD-006 | Support route unavailable | Blocked | Support owner | EVD-004 | Blocks real intake. | Confirm support route. |
| AUD-007 | Official Toastmasters boundary unresolved | Blocked | Official-route owner | EVD-005 | Blocks member route. | Review official boundary. |
| AUD-008 | Barayamal minimisation pending | Hold | Barayamal program operator | EVD-006 | Blocks Barayamal-only rehearsal. | Minimise fields. |
| AUD-009 | Dean advisory boundary ready | Ready | Pilot owner | EVD-007 | Advisory boundary clear. | Collect comments. |
| AUD-010 | Technical revoke proof pending | Hold | Technical/admin custodian | EVD-009 | Blocks sandbox launch. | Run revoke proof. |
| AUD-011 | Technical backup/export/delete pending | Hold | Technical/admin custodian | EVD-010 | Blocks closeout. | Run operations proof. |
| AUD-012 | Redaction checklist pending | Hold | Comms lead | EVD-012 | Blocks public update. | Close checklist. |
| AUD-013 | Cultural protocol stop rule blocked | Blocked | Cultural safety reviewer | EVD-016 | Blocks any cultural material handling. | Confirm stop rule. |
| AUD-014 | Overall posture remains hold | Hold | Authority chair | ODR-016 | Real intake remains closed. | Run private meeting. |
